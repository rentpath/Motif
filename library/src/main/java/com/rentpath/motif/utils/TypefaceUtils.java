...
public final class TypefaceUtils {
    ...
    private static final Map<Typeface, MotifTypefaceSpan> sCachedSpans = new HashMap<Typeface, MotifTypefaceSpan>();
     ...
     */
    public static MotifTypefaceSpan getSpan(final Typeface typeface) {
        if (typeface == null) return null;
        synchronized (sCachedSpans) {
            if (!sCachedSpans.containsKey(typeface)) {
                final MotifTypefaceSpan span = new MotifTypefaceSpan(typeface);
